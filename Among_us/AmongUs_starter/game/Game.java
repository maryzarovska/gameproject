         ...
         public void handle(KeyEvent event) {
            ...
            switch (event.getCode()) {
               ...
               case RIGHT:
                  ...
                  /*
                   * while (goRIGHT) {
                   * CREWMATE_IMAGE = "Stormtrooper_Leftstep_one.psd";
                   * CREWMATE_IMAGE = "Stormtrooper_Leftstep_two";
                   * }
                   */
                  break;
               case LEFT:
                  ...
                  /*
                   * while (goLEFT) {
                   * CREWMATE_IMAGE = "Stormtrooper_Rightstep_one";
                   * CREWMATE_IMAGE = "Stormtrooper_Rightstep_two";
                   * }
                   */
                  break;
      ...
      public void update() {
         ...
         if (isMaster) {
            ...
            new AnimationTimer() {
               ...
               private final long longDelay = 9000_000_000L;
